package com.module.checkview.expandablerecyclerview;
...
import com.module.checkview.expandablerecyclerview.listeners.ExpandCollapseListener;
import com.module.checkview.expandablerecyclerview.listeners.GroupExpandCollapseListener;
...
import com.module.checkview.expandablerecyclerview.models.ExpandableList;
...
public abstract class ExpandableRecyclerViewAdapter<GVH extends GroupViewHolder, CVH extends ChildViewHolder>
  ...
  private GroupExpandCollapseListener
  ...
  public void onBindViewHolder(ViewHolder holder, int position) {
    ...
    switch (listPos.type) {
      case ExpandableListPosition.GROUP:
        onBindGroupViewHolder((GVH) holder, listPos.groupPos, group);
        ...
        break;
      case ExpandableListPosition.CHILD:
        onBindChildViewHolder((CVH) holder, listPos.groupPos, group, listPos.childPos);
        break;
    }
  }
